...
describe("Gilded Rose", () => {
    ...
    it("Should increase Quality for AgedBrie with Quality<50",() => {
    ...
    it("Should decrease Quality twice if sellin<=0",() => {
        const gildedRose = new GildedRose([ new Item('Something', -1, 20) ]);
        gildedRose.updateQuality();
